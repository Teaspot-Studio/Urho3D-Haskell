...
import Graphics.Urho3D.Math.Frustum as X
import Graphics.Urho3D.Math.Matrix3x4 as X
import Graphics.Urho3D.Math.Matrix4 as X
import Graphics.Urho3D.Math.Plane as X
import Graphics.Urho3D.Math.Polyhedron as X
import Graphics.Urho3D.Math.Quaternion as X
import Graphics.Urho3D.Math.Random as X
import Graphics.Urho3D.Math.Rect as X
import Graphics.Urho3D.Math.Sphere as X
...
import Graphics.Urho3D.Math.Vector4 as X